...
{
  $is=$_GET['isb'];
  $sql = "DELETE from reservedbooks where ISBN='".$is."'";
  $conn= mysqli_connect("localhost","root","","library");
$query = mysqli_query($conn,$sql);
header('location:reservedbooks.php');
}
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php 
$sql="SELECT title,ISBN,reservedate,StudentId from reservedbooks";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><a href="isseu-book.php?isb=<?php echo htmlentities($result->ISBN);?>"><button class="btn btn-danger">Issue</button></a></td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
                                </table>
